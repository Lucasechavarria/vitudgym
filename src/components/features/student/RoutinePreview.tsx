                ...
                <div className="relative z-10 space-y-4">
                    ...
                    <div className="flex gap-2">
                        <Link
                            ...
                            className="flex-1 bg-blue-600 hover:bg-blue-500 text-white font-bold py-3 rounded-xl text-center transition-all shadow-lg shadow-blue-600/20 hover:scale-[1.02]"
                        >
                            Ver Rutina
                        </Link>
