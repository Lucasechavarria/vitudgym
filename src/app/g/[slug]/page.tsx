...
export default function GymPublicLanding({ params }: { params: { slug: string } }) {
    ...
    if (loading) return <div className="min-h-screen bg-black flex items-center justify-center text-white italic">Cargando experiencia...</div>;
    ...
    return (
        <div className="min-h-screen bg-black text-white selection:bg-red-500 selection:text-white overflow-x-hidden">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 p-6 flex justify-between items-center bg-gradient-to-b from-black/80 to-transparent backdrop-blur-sm">
                ...
                <Link
                    href="/login"
                    className="px-6 py-2 bg-white text-black rounded-full font-black text-[10px] uppercase tracking-widest hover:bg-red-600 hover:text-white transition-all shadow-lg"
                >
                    Acceso Alumno
                </Link>
            </nav>
                ...
                <div className="relative z-10 text-center max-w-4xl px-6">
                    ...
                    >
                        <button
                            ...
                            style={{ backgroundColor: gym.color_primario || '#ef4444' }}
                        >
                            Comenzar Ahora
                        </button>
            ...
            <section id="nosotros" className="py-32 px-6">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
                    <div className="p-10 bg-[#111] rounded-[3rem] border border-white/5 space-y-4">
                        ...
                        <h4 className="text-xl font-black italic uppercase italic tracking-tight">Equipamiento Top</h4>
                    ...
                    <div className="p-10 bg-[#111] rounded-[3rem] border border-white/5 space-y-4">
                        ...
                        <h4 className="text-xl font-black italic uppercase italic tracking-tight">Staff de Élite</h4>
                    ...
                    <div className="p-10 bg-[#111] rounded-[3rem] border border-white/5 space-y-4">
                        ...
                        <h4 className="text-xl font-black italic uppercase italic tracking-tight">Tecnología Virtud</h4>
